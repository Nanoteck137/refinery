...
func RenderCallbackSuccess(w io.Writer) error {
	return templates.ExecuteTemplate(w, "base", Data{
		Icon:    "success",
		AppName: refinery.AppName,
		Header:  "Login Successful!",
		Content: template.HTML(fmt.Sprintf("You have been authenticated to <strong>%s</strong> successfully.<br>You can now close this tab.", refinery.AppName)),
	})
}
